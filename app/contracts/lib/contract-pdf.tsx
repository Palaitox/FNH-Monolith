 ...
 *   otro_si              → OtroSiPago   (modificación de fecha de pago)
 *   otro_si_ampliacion   → OtroSiAmpliacion (ampliación del término, 3 páginas)
 */
...
function OtroSiAmpliacion({ v }: { v: ContractVars }) {
...
export async function generateContractPdf(vars: ContractVars, tipo: string): Promise<Blob> {
  ...
  } else if (tipo === 'otro_si_ampliacion') {
    doc = <OtroSiAmpliacion v={vars} />
  } else if (tipo === 'otro_si') {
    doc = <OtroSiPago v={vars} />
  } else {
